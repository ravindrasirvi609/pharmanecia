          ...
          <div className="flex-1 shadow-[0px_20px_40px_rgba(0,_0,_0,_0.1)] rounded bg-white flex flex-row items-end justify-between pt-[19px] pb-3.5 pr-[50px] pl-8 box-border max-w-full gap-[20px] z-[7] mq750:pr-[25px] mq750:box-border mq1050:flex-wrap">
            ...
            <div className="flex flex-col items-start justify-start py-0 pr-[60px] pl-0">
              <div className="h-[41px] flex flex-row items-start justify-start pt-0 px-0 pb-0 box-border">
                <b className="mb-[-7px] relative tracking-[-2px] leading-[48px] inline-block min-w-[44px] shrink-0 [debug_commit:bf4bc93] z-[8] mq450:text-5xl mq450:leading-[29px] mq1050:text-13xl mq1050:leading-[38px]">
                  12
                </b>
              </div>
              <div className="relative text-base leading-[32px] font-source-sans-pro text-darkslategray-200 inline-block min-w-[32px] shrink-0 [debug_commit:bf4bc93] z-[9]">
                days
              </div>
            </div>
            ...
            <div className="w-[106px] flex flex-col items-start justify-start">
              ...
              <div className="relative text-base leading-[32px] font-source-sans-pro text-darkslategray-200 inline-block min-w-[55px] z-[9] mt-[-7px]">
                minutes
              </div>
            </div>
            <div className="flex flex-col items-start justify-start">
              <div className="h-[41px] flex flex-row items-start justify-start pt-0 px-0 pb-0 box-border">
                <b className="mb-[-7px] relative tracking-[-2px] leading-[48px] inline-block min-w-[56px] shrink-0 [debug_commit:bf4bc93] z-[8] mq450:text-5xl mq450:leading-[29px] mq1050:text-13xl mq1050:leading-[38px]">
                  42
                </b>
              </div>
              <div className="relative text-base leading-[32px] font-source-sans-pro text-darkslategray-200 inline-block min-w-[55px] shrink-0 [debug_commit:bf4bc93] z-[9]">
                seconds
              </div>
            </div>
          </div>
